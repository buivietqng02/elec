define(['app/constant', 'shared/data'], (constant, GLOBAL) => {
    const template = {
        ...
        mess: `
            <li class="js_li_list_mess {who} {classLocal} messages__item {isFile} {bookmark} {pinned} {beginChat}" data-id-local="{idLocal}" ${constant.ATTRIBUTE_MESSAGE_ID}="{id}" data-chat-type="{chatType}">
